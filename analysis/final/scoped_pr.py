...
print(f"\n{'method':28s}{'ARI_full':>10}{'P_full':>9}{'R_full':>9}   |{'ARI_scop':>10}{'P_scop':>9}{'R_scop':>9}")
for name, cl in reported.items():
    af, pf, rf = pr(cl, threatfox_labels)
    as_, ps, rs = pr(cl, scoped_labels)
    print(f"{name:28s}{af:10.4f}{pf:9.4f}{rf:9.4f}   |{as_:10.4f}{ps:9.4f}{rs:9.4f}")
